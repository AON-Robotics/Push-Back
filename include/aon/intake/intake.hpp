...
class Intake {
 ...
 public:
  Intake(const std::initializer_list<okapi::Motor> &allPorts,
         const std::initializer_list<okapi::Motor> &railPort,
         const std::initializer_list<okapi::Motor> &gatePort,
  ...
  /// @details For this function, the drivetrain logic can be accessed via a bool in
  ///          autonomous so that So instead of using drivetrain logic here just use a
  ///          bool to not have drivetrain logic here.
  void scan();
