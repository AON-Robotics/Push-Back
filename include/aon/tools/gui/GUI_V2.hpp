...
static void DisplayDebugMenu4() {
  ...
  const int dt_ms = static_cast<int>(::sensorFeeder.last_dt_s() * 1000.0);
  const double vx_inps = ::sensorFeeder.last_vx_inps();
  ...
  int y = 60;
  pros::screen::set_pen(COLOR_WHITE);
  pros::screen::print(pros::E_TEXT_MEDIUM, 20, y, "dt_ms: %d", dt_ms); y += 30;
  pros::screen::print(pros::E_TEXT_MEDIUM, 20, y, "vx_inps: %.2f", vx_inps); y += 30;
  pros::screen::print(pros::E_TEXT_MEDIUM, 20, y, "ekf.x_in: %.1f", s.x_in); y += 30;
  pros::screen::print(pros::E_TEXT_MEDIUM, 20, y, "ekf.y_in: %.1f", s.y_in); y += 30;
  pros::screen::print(pros::E_TEXT_MEDIUM, 20, y, "theta_deg: %.1f", theta_deg); y += 30;
  pros::screen::print(pros::E_TEXT_MEDIUM, 20, y, "gpsErr_cm: %.1f", gpsErr_cm); y += 30;
}
